...
@section('auth_body')
    <form action="{{ $registerUrl }}" method="post">
        ...
        <div class="row">
            <div class="col-12">
                <div class="icheck-primary" title="{{ __('adminlte.is_user_admin_hint') }}">
                    <input id="isUserAdmin" type="checkbox" name="is_user_admin"
                        {{ old('is_user_admin') ? 'checked' : '' }}>

                    <label for="isUserAdmin">
                        {{ __('adminlte.is_user_admin') }}
                    </label>
                </div>
            </div>
        </div>
